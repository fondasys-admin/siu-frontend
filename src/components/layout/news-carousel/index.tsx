        ...
        <div key={animKey} className="absolute bottom-0 left-0 right-0 p-6 sm:p-12 flex flex-col gap-4 sm:gap-6">
          <div className="flex flex-col gap-2 sm:gap-4">
            <div>
              ...
              <h2 className="animate-fade-up text-white text-2xl sm:text-5xl font-bold leading-tight sm:leading-[68px] tracking-[-0.5px] capitalize" style={{ animationDelay: '80ms' }}>
                {activeItem.title}
              </h2>
            </div>
